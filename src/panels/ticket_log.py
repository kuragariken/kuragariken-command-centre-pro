...
class TicketLogPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        title.setStyleSheet("background:transparent;color:#00e87a;font-size:11px;"
        ...
        report_btn.setStyleSheet(
            ...
            "border-radius:6px;padding:4px 12px;font-size:10px;font-weight:600;}"
        ...
        # ── Quick entry row ───────────────────────────────────────
        entry = QWidget()
        entry.setStyleSheet("background:rgba(6,10,18,0.85); border-bottom:1px solid rgba(255,255,255,0.07);")
        ...
        self._ticket_num.setStyleSheet(
            "QLineEdit{background:#111827;color:#cdd9e5;border:1px solid #1f2d3d;"
            "border-radius:7px;padding:5px 10px;font-size:11px;font-family:'JetBrains Mono','Cascadia Code','Fira Code','Consolas',monospace;}"
        ...
        self._ticket_desc.setStyleSheet(
            "QLineEdit{background:#111827;color:#cdd9e5;border:1px solid #1f2d3d;"
        ...
        self._ticket_status.setStyleSheet(
            "QComboBox{background:#111827;color:#cdd9e5;border:1px solid #1f2d3d;"
            "border-radius:7px;padding:5px 8px;font-size:11px;}"
            "QComboBox:focus{border-color:#00e87a;}"
            "QComboBox::drop-down{border:none;width:20px;}"
            "QComboBox QAbstractItemView{background:#111827;color:#cdd9e5;"
            "border:1px solid #1f2d3d;selection-background-color:#182030;}")
        ...
        self._stats_lbl.setStyleSheet(
            "background:transparent;color:#4a5568;font-size:10px;border:none;")
