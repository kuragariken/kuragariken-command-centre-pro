...
class AlarmOverlay(QWidget):
    ...
    def _build_card(self):
        ...
        self._time_lbl.setStyleSheet("background:transparent;color:#6b83a0;border:none;")
        ...
        for mins in SNOOZE_MINUTES:
            ...
            sb.setStyleSheet(
                ...
                f"border-radius:12px;padding:0 16px;font-weight:600;}}"
        ...
        dismiss.setStyleSheet(
            ...
            f"color:#060a10;border:none;border-radius:12px;font-weight:700;"
...
class RemindersPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        add_btn.setStyleSheet(
            "QPushButton{background:#00e87a;color:#080b12;border:none;border-radius:8px;"
        ...
        self._list.setStyleSheet(
            ...
            "QListWidget::item:hover{background:#182030;border-color:#6e7d90;}"
        ...
        test_btn.setStyleSheet(
            ...
            "border-radius:8px;padding:2px 10px;font-size:10px;font-weight:600;}"
            "QPushButton:hover{color:#cdd9e5;border-color:#6e7d90;background:#182030;}")
    ...
    def refresh(self):
        ...
        for r in self.app.data.get("reminders", []):
            ...
            if not enabled:
                item.setForeground(QColor("#6e7d90"))
            elif snoozed:
                item.setForeground(QColor("#fbbf24"))
            self._list.addItem(item)
        show_empty_state(self._list,
            "No reminders set — add one below to get pinged later.")
...
class ReminderDialog(QDialog):
    ...
    def _build(self):
        ...
        ok = QPushButton("Save"); ok.setStyleSheet("QPushButton{background:#00e87a;color:#080b12;border:none;border-radius:8px;padding:5px 14px;font-weight:700;} QPushButton:hover{background:#00ff88;}")
