...
class VaultWindow(QWidget):
    ...
    def __init__(self, app_win):
        ...
        # Widened from 400 → 480: the add-entry bar packs five controls
        # (label, secret, generate, category, save) that were badly cramped
        # at 400px. 480 gives each field a usable width without feeling large.
    ...
    def _build_ui(self):
        ...
        self._lock_btn.setStyleSheet(
            ...
            "border-radius:8px;padding:0 14px;font-size:11px;font-weight:700;}"
    ...
    def _build_setup_page(self) -> QWidget:
        ...
        sub.setStyleSheet("background:transparent;color:#6e7d90;font-size:10px;border:none;")
        cl.addWidget(sub)
        ...
        self._strength_lbl.setStyleSheet(
            "background:transparent;color:#6e7d90;font-size:9px;font-weight:700;border:none;")
    ...
    def _build_lock_page(self) -> QWidget:
        ...
        enc.setStyleSheet(
            "background:transparent;color:#6b83a0;font-size:9px;"
        ...
        chg.setStyleSheet(
            "QPushButton{background:transparent;color:#6b83a0;border:none;font-size:10px;}"
    ...
    def _build_unlocked_page(self) -> QWidget:
        ...
        gen_btn.setStyleSheet(
            ...
            "border:1px solid rgba(255,255,255,0.08);border-radius:8px;font-size:10px;}"
        ...
        add_btn.setStyleSheet(
            "QPushButton{background:#00e87a;color:#080b12;border:none;"
            "border-radius:8px;padding:0 12px;font-weight:700;font-size:11px;}"
            "QPushButton:hover{background:#00ff88;}")
        ...
        tip.setStyleSheet("background:transparent;color:#6b83a0;font-size:9px;border:none;")
        fl.addWidget(tip)
        ul.addWidget(ft)
        return pg
    ...
    def _rebuild_entries(self):
        ...
        show_empty_state(self._entry_list,
            "Vault is empty — add a secret to store it encrypted.", icon="🔒")
        n = len(entries)
    ...
    def _small_lbl(self, text):
        l = QLabel(text)
        l.setStyleSheet(
            f"background:transparent;color:#6e7d90;font-size:9px;"
...
class RevealDialog(QDialog):
    def __init__(self, label, plaintext, cat, added, parent):
        ...
        meta.setStyleSheet("background:transparent;color:#6e7d90;font-size:10px;border:none;")
        lay.addWidget(meta)
...
class ChangePasswordDialog(QDialog):
    def __init__(self, salt_hex, canary, current_pw, parent):
        ...
        sty = ("QLineEdit{background:#0d1117;color:#e2e8f0;border:1px solid #1f2d3d;"
               "border-radius:8px;padding:6px 12px;font-size:12px;font-family:'Consolas';}"
    ...
    def _lbl(self, t):
        l = QLabel(t)
        l.setStyleSheet("background:transparent;color:#6e7d90;font-size:9px;"
