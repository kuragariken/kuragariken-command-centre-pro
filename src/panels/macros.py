...
class MacrosPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        hdr = QWidget(); hdr.setStyleSheet("background:rgba(6,10,18,0.85); border-bottom:1px solid rgba(255,255,255,0.07);"); hdr.setFixedHeight(44)
        hdr_lay = QHBoxLayout(hdr)
        hdr_lay.setContentsMargins(16, 0, 12, 0)
        hdr_lay.addWidget(self._lbl("MACROS"))
        hdr_lay.addStretch()
        add = QPushButton("＋ Macro"); add.setStyleSheet("QPushButton{background:#00e87a;color:#080b12;border:none;border-radius:6px;padding:5px 14px;font-weight:700;} QPushButton:hover{background:#00ff88;}")
        ...
        self._status = QLabel("")
        self._status.setStyleSheet("background:transparent; color:#4a5568; font-size:11px; border:none;")
...
class MacroDialog(QDialog):
    ...
    def _build(self):
        ...
        ok = QPushButton("Save"); ok.setStyleSheet("QPushButton{background:#00e87a;color:#080b12;border:none;border-radius:6px;padding:5px 14px;font-weight:700;} QPushButton:hover{background:#00ff88;}"); ok.clicked.connect(self._save)
