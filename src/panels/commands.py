...
class CommandsPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        icon.setStyleSheet("background:transparent;color:#4a5568;font-size:15px;border:none;")
        sl.addWidget(icon)
        ...
        for cat in self.app.data.get("categories", []):
            ...
            if active:
                ...
                btn.setStyleSheet(
                    ...
                    f"border-radius:13px;padding:2px 14px;font-size:10px;font-weight:700;}}"
                ...
                btn.setStyleSheet(
                    ...
                    f"border-radius:13px;padding:2px 12px;font-size:10px;font-weight:500;}}"
