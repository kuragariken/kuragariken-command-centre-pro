...
class HistoryPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        hdr = QWidget(); hdr.setFixedHeight(44); hdr.setStyleSheet("background:qlineargradient(x1:0,y1:0,x2:0,y2:1,stop:0 rgba(14,20,30,0.92),stop:1 rgba(6,10,18,0.85)); border-top:1px solid rgba(255,255,255,0.06); border-bottom:1px solid rgba(255,255,255,0.07);")
        hdr_lay = QHBoxLayout(hdr)
        hdr_lay.setContentsMargins(16, 0, 12, 0)
        hdr_lay.addWidget(self._lbl("HISTORY"))
        hdr_lay.addStretch()
        clear = QPushButton("Clear"); clear.setStyleSheet("QPushButton{background:transparent;color:#6e7d90;border:none;border-radius:8px;padding:4px 8px;} QPushButton:hover{color:#cdd9e5;background:#111827;}")
        ...
        themed(self, tabs,
            ...
            'QTabBar::tab{{background:transparent;color:{dim};border:none;'
    ...
    def refresh(self):
        ...
        show_empty_state(self._hist_list,
            "No clipboard history yet — copied commands will show up here.")
        ...
        show_empty_state(self._fav_list,
            "No favourites yet — star a command to pin it here.")
